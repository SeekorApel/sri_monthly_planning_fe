...
export class RestService {
  ...
  public getRoles(): Observable<Role> {
    return this.http
      .get(environment.apiUrlWebAdmin + "/roles")
      .pipe(
        map(response => {
  ...
  public getPermissions(): Observable<Permission> {
    return this.http
      .get(environment.apiUrlWebAdmin + "/permissions")
      .pipe(
        map(response => {
  ...
  public deleteRole(roleId): Observable<Role> {
    return this.http
      .delete(
        environment.apiUrlWebAdmin + "/role/"+ roleId
      )
      .pipe(
        map(response => {
          return new Role(response);
  ...
  public deletePermission(permissionId): Observable<Permission> {
    return this.http
      .delete(
        environment.apiUrlWebAdmin + "/permission/"+ permissionId
      )
      .pipe(
        map(response => {
          return new Permission(response);
